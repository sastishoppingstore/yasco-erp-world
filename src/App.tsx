...
const NPHIESDashboardPage = lazy(() => import("./pages/admin/compliance/NPHIESDashboard"));
const BaladyPermitsPage = lazy(() => import("./pages/admin/compliance/BaladyPermits"));
...
const MobileTechnicianJobsPage = lazy(() => import("./pages/mobile/TechnicianJobs"));
const MobileSiteExpensePage = lazy(() => import("./pages/mobile/SiteExpense"));
...
const HealthcareLab = lazy(() => import("./pages/verticals/healthcare/Lab"));
const HealthcareBilling = lazy(() => import("./pages/verticals/healthcare/Billing"));
const HealthcareNursing = lazy(() => import("./pages/verticals/healthcare/Nursing"));
...
const EducationExams = lazy(() => import("./pages/verticals/education/Exams"));
const EducationLibrary = lazy(() => import("./pages/verticals/education/Library"));
...
const WorkshopParts = lazy(() => import("./pages/verticals/workshop/Parts"));
const WorkshopPayments = lazy(() => import("./pages/verticals/workshop/Payments"));
...
const HotelEvents = lazy(() => import("./pages/verticals/hotel/Events"));
...
const ConstructionQuality = lazy(() => import("./pages/verticals/construction/Quality"));
...
const TransportTracking = lazy(() => import("./pages/verticals/transport/Tracking"));
const TransportFuel = lazy(() => import("./pages/verticals/transport/Fuel"));
const VerticalWorkspacePage = lazy(() => import("./pages/verticals/workspace/VerticalWorkspacePage"));
...
const RealEstateTenants = lazy(() => import("./pages/verticals/realestate/Tenants"));
...
const LaundryPage = lazy(() => import("./pages/verticals/laundry/index"));
const SalonPage = lazy(() => import("./pages/verticals/salon/index"));
const GymPage = lazy(() => import("./pages/verticals/gym/index"));
const EcommercePage = lazy(() => import("./pages/verticals/ecommerce/index"));
const HostelDashboard = lazy(() => import("./pages/verticals/hostel/index"));
const HostelRooms = lazy(() => import("./pages/verticals/hostel/Rooms"));
const HostelBookings = lazy(() => import("./pages/verticals/hostel/Bookings"));
const HostelRentInvoicing = lazy(() => import("./pages/verticals/hostel/RentInvoicing"));
const HostelHousekeeping = lazy(() => import("./pages/verticals/hostel/Housekeeping"));
const PharmacyDashboard = lazy(() => import("./pages/verticals/pharmacy/index"));
const PharmacyPrescriptions = lazy(() => import("./pages/verticals/pharmacy/Prescriptions"));
const PharmacyStock = lazy(() => import("./pages/verticals/pharmacy/Stock"));
const PharmacySuppliers = lazy(() => import("./pages/verticals/pharmacy/Suppliers"));
const PharmacyExpiry = lazy(() => import("./pages/verticals/pharmacy/Expiry"));
const RestaurantPage = lazy(() => import("./pages/verticals/restaurant/index"));
const RestaurantMenu = lazy(() => import("./pages/verticals/restaurant/Menu"));
const RestaurantTables = lazy(() => import("./pages/verticals/restaurant/Tables"));
const RestaurantKitchen = lazy(() => import("./pages/verticals/restaurant/Kitchen"));
const RestaurantDelivery = lazy(() => import("./pages/verticals/restaurant/Delivery"));
const ManufacturingQuality = lazy(() => import("./pages/verticals/manufacturing/Quality"));
const RetailLoyalty = lazy(() => import("./pages/verticals/retail/Loyalty"));
const ServiceContracts = lazy(() => import("./pages/verticals/services/Contracts"));
...
export default function App() {
  return (
    ...
    <Routes>
      ...
      <Route path="/app/admin/compliance/nphies" element={<LayoutWrapper><NPHIESDashboardPage /></LayoutWrapper>} />
      <Route path="/app/admin/compliance/balady" element={<LayoutWrapper><BaladyPermitsPage /></LayoutWrapper>} />
      ...
      <Route path="/app/mobile/technician-jobs" element={<LayoutWrapper><MobileTechnicianJobsPage /></LayoutWrapper>} />
      <Route path="/app/mobile/site-expense" element={<LayoutWrapper><MobileSiteExpensePage /></LayoutWrapper>} />
      ...
      <Route path="/app/verticals/healthcare/lab" element={<LayoutWrapper><HealthcareLab /></LayoutWrapper>} />
      <Route path="/app/verticals/healthcare/billing" element={<LayoutWrapper><HealthcareBilling /></LayoutWrapper>} />
      <Route path="/app/verticals/healthcare/nursing" element={<LayoutWrapper><HealthcareNursing /></LayoutWrapper>} />
      ...
      <Route path="/app/verticals/education/exams" element={<LayoutWrapper><EducationExams /></LayoutWrapper>} />
      <Route path="/app/verticals/education/library" element={<LayoutWrapper><EducationLibrary /></LayoutWrapper>} />
      ...
      <Route path="/app/verticals/workshop/parts" element={<LayoutWrapper><WorkshopParts /></LayoutWrapper>} />
      <Route path="/app/verticals/workshop/payments" element={<LayoutWrapper><WorkshopPayments /></LayoutWrapper>} />
      ...
      <Route path="/app/verticals/hotel/events" element={<LayoutWrapper><HotelEvents /></LayoutWrapper>} />
      ...
      <Route path="/app/verticals/construction/quality" element={<LayoutWrapper><ConstructionQuality /></LayoutWrapper>} />
      ...
      <Route path="/app/verticals/transport/tracking" element={<LayoutWrapper><TransportTracking /></LayoutWrapper>} />
      <Route path="/app/verticals/transport/fuel" element={<LayoutWrapper><TransportFuel /></LayoutWrapper>} />
      ...
      <Route path="/app/verticals/real-estate/tenants" element={<LayoutWrapper><RealEstateTenants /></LayoutWrapper>} />
      ...
      {/* Hostel Verticals */}
      <Route path="/app/verticals/hostel" element={<LayoutWrapper><HostelDashboard /></LayoutWrapper>} />
      <Route path="/app/verticals/hostel/rooms" element={<LayoutWrapper><HostelRooms /></LayoutWrapper>} />
      <Route path="/app/verticals/hostel/bookings" element={<LayoutWrapper><HostelBookings /></LayoutWrapper>} />
      <Route path="/app/verticals/hostel/rent-invoicing" element={<LayoutWrapper><HostelRentInvoicing /></LayoutWrapper>} />
      <Route path="/app/verticals/hostel/housekeeping" element={<LayoutWrapper><HostelHousekeeping /></LayoutWrapper>} />

      {/* Pharmacy Verticals */}
      <Route path="/app/verticals/pharmacy" element={<LayoutWrapper><PharmacyDashboard /></LayoutWrapper>} />
      <Route path="/app/verticals/pharmacy/prescriptions" element={<LayoutWrapper><PharmacyPrescriptions /></LayoutWrapper>} />
      <Route path="/app/verticals/pharmacy/stock" element={<LayoutWrapper><PharmacyStock /></LayoutWrapper>} />
      <Route path="/app/verticals/pharmacy/suppliers" element={<LayoutWrapper><PharmacySuppliers /></LayoutWrapper>} />
      <Route path="/app/verticals/pharmacy/expiry" element={<LayoutWrapper><PharmacyExpiry /></LayoutWrapper>} />

      {/* New Verticals */}
      <Route path="/app/verticals/laundry" element={<LayoutWrapper><LaundryPage /></LayoutWrapper>} />
      <Route path="/app/verticals/laundry/orders" element={<LayoutWrapper><LaundryPage /></LayoutWrapper>} />
      <Route path="/app/verticals/laundry/delivery" element={<LayoutWrapper><LaundryPage /></LayoutWrapper>} />
      <Route path="/app/verticals/salon" element={<LayoutWrapper><SalonPage /></LayoutWrapper>} />
      <Route path="/app/verticals/salon/appointments" element={<LayoutWrapper><SalonPage /></LayoutWrapper>} />
      <Route path="/app/verticals/salon/staff" element={<LayoutWrapper><SalonPage /></LayoutWrapper>} />
      <Route path="/app/verticals/salon/packages" element={<LayoutWrapper><SalonPage /></LayoutWrapper>} />
      <Route path="/app/verticals/gym" element={<LayoutWrapper><GymPage /></LayoutWrapper>} />
      <Route path="/app/verticals/gym/memberships" element={<LayoutWrapper><GymPage /></LayoutWrapper>} />
      <Route path="/app/verticals/gym/checkins" element={<LayoutWrapper><GymPage /></LayoutWrapper>} />
      <Route path="/app/verticals/gym/classes" element={<LayoutWrapper><GymPage /></LayoutWrapper>} />
      <Route path="/app/verticals/ecommerce" element={<LayoutWrapper><EcommercePage /></LayoutWrapper>} />
      <Route path="/app/verticals/ecommerce/orders" element={<LayoutWrapper><EcommercePage /></LayoutWrapper>} />
      <Route path="/app/verticals/ecommerce/sync" element={<LayoutWrapper><EcommercePage /></LayoutWrapper>} />
      <Route path="/app/verticals/ecommerce/courier" element={<LayoutWrapper><EcommercePage /></LayoutWrapper>} />
      <Route path="/app/verticals/restaurant" element={<LayoutWrapper><RestaurantPage /></LayoutWrapper>} />
      <Route path="/app/verticals/restaurant/menu" element={<LayoutWrapper><RestaurantMenu /></LayoutWrapper>} />
      <Route path="/app/verticals/restaurant/tables" element={<LayoutWrapper><RestaurantTables /></LayoutWrapper>} />
      <Route path="/app/verticals/restaurant/delivery" element={<LayoutWrapper><RestaurantDelivery /></LayoutWrapper>} />
      <Route path="/app/verticals/restaurant/kitchen" element={<LayoutWrapper><RestaurantKitchen /></LayoutWrapper>} />
      <Route path="/app/verticals/restaurant/reservations" element={<LayoutWrapper><RestaurantPage /></LayoutWrapper>} />
      <Route path="/app/verticals/manufacturing/quality" element={<LayoutWrapper><ManufacturingQuality /></LayoutWrapper>} />
      <Route path="/app/verticals/retail/loyalty" element={<LayoutWrapper><RetailLoyalty /></LayoutWrapper>} />
      <Route path="/app/verticals/services/contracts" element={<LayoutWrapper><ServiceContracts /></LayoutWrapper>} />

      {/* Vertical Workspaces — config-driven premium workspaces for Saudi-market
          verticals (fieldservice, events, agency, professional, agriculture, energy,
          mining, marine, veterinary, nonprofit, tailoring, jewelry, repair, furniture,
          printing, watersvc, finserv, importexport). See src/config/verticalWorkspaces.ts */}
      <Route path="/app/verticals/ws/:verticalId" element={<LayoutWrapper><VerticalWorkspacePage /></LayoutWrapper>} />
