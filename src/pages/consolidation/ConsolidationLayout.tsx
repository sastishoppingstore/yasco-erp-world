...
import {
  LayoutDashboard, Menu, Building2, ArrowLeftRight, FileSpreadsheet,
...
const navSections = [
  {
    label: "Groups",
    items: [
      { label: "All Groups", path: "/app/consolidation/groups", icon: Building2 },
    ],
  },
  {
    label: "Intercompany",
    items: [
      { label: "Transactions", path: "/app/consolidation/intercompany", icon: ArrowLeftRight },
    ],
  },
  {
    label: "Entries",
    items: [
      { label: "All Entries", path: "/app/consolidation/entries", icon: FileSpreadsheet },
    ],
  },
  {
    label: "Eliminations",
    items: [
      { label: "Eliminations", path: "/app/consolidation/eliminations", icon: GitCompare },
    ],
  },
];
...
function Sidebar() {
  ...
  return (
    <div className="flex h-full flex-col gap-1 py-2">
      <NavLink to="/app/consolidation" end className="mx-3 mb-2">
      ...
      <ScrollArea className="flex-1 px-3">
        <nav className="flex flex-col gap-1">
          <NavLink to="/app/consolidation" end className={({ isActive }) => cn(
...
export default function ConsolidationLayout() {
