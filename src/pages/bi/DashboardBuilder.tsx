        ...
        <div className="p-2" style={{ height: widget.height * 80 - 40 }}>
          ...
          {widget.widgetType === "bar_chart" && (
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={[{ name: "A", value: 10 }, { name: "B", value: 20 }, { name: "C", value: 15 }]}>
          ...
          {widget.widgetType === "line_chart" && (
            <ResponsiveContainer width="100%" height="100%">
              <RLineChart data={[{ month: "Jan", value: 100 }, { month: "Feb", value: 120 }]}>
                <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" />
          ...
          {widget.widgetType === "pie_chart" && (
            <ResponsiveContainer width="100%" height="100%">
              <RPieChart>
                <Pie data={[{ name: "A", value: 40 }, { name: "B", value: 30 }, { name: "C", value: 30 }]} cx="50%" cy="50%" outerRadius={60} dataKey="value">
