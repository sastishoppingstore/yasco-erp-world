      ...
      <Card>
        <CardContent className="p-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <a href="/app/notifications/preferences" className="p-3 rounded-lg bg-purple-50 dark:bg-purple-900/30 text-center text-sm font-medium text-purple-700 dark:text-purple-300">
              Settings
            </a>
          </div>
        </CardContent>
