...
import {
  LayoutDashboard, Menu, Building2, FileSpreadsheet, CalendarCheck,
...
const navSections = [
  {
    label: "Obligations",
    items: [
      { label: "Performance Obligations", path: "/app/ifrs15/obligations", icon: FileSpreadsheet },
    ],
  },
  {
    label: "Contracts",
    items: [
      { label: "Contract Assets", path: "/app/ifrs15/contracts/assets", icon: DollarSign },
      { label: "Contract Liabilities", path: "/app/ifrs15/contracts/liabilities", icon: Building2 },
    ],
  },
  {
    label: "Schedules",
    items: [
      { label: "Recognition Schedule", path: "/app/ifrs15/schedules", icon: CalendarCheck },
    ],
  },
  {
    label: "Costs",
    items: [
      { label: "Contract Costs", path: "/app/ifrs15/costs", icon: DollarSign },
    ],
  },
];
...
function Sidebar() {
  ...
  return (
    <div className="flex h-full flex-col gap-1 py-2">
      <NavLink to="/app/ifrs15" end className="mx-3 mb-2">
      ...
      <ScrollArea className="flex-1 px-3">
        <nav className="flex flex-col gap-1">
          <NavLink to="/app/ifrs15" end className={({ isActive }) => cn(
...
export default function IFRS15Layout() {
